...
import UnreadableCustom from "./Layout/Panel/unreadableCustom";
import EditOrder from "./Layout/Panel/EditeOrder";
/////////////main/////////////
                  ...
                  <Col sm={10} className="content">
                    <Tab.Content>
                      ...
                      <Tab.Pane eventKey="myorders">
                        ...
                        {step===2&&<EditOrder setstep={(x)=>setstep(x)}/>}
                        {step===3&&<UnreadableCustom setstep={(x)=>setstep(x)}/>}
                      </Tab.Pane>
