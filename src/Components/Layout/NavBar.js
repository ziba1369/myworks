                        ...
                        <Row className="col-xl-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <Col xl={4} md={4} sm={12} xs={12}>
                                ...
                                <Nav style={styleTwo} className="loginprofile">
                                    <Col xl={6} md={6} sm={12} xs={12}>
                                        <Nav className="user">
                                            <NavDropdown title={Cookies.get("name") + " " + Cookies.get("family")}
                                                         id="nav-dropdown">
                                                <span className="imageprofile"><NavDropdown.Item eventKey="4.1"><Image
                                                    src={profileImage}/>پروفایل</NavDropdown.Item></span>
                                                <span className="imagelogout" onClick={handlelogout}> <NavDropdown.Item
                                                    eventKey="4.2"><Image
                                                    src={logoutImage}/>خروج از حساب کاربری</NavDropdown.Item></span>
                                            </NavDropdown>
                                        </Nav>
                                    </Col>
                                    <Col xl={6} md={6} sm={12} xs={12}>
