                    ...
                    <div className="uploadphoto">
                        <Row>
                            <div className="upload-text">
                                <p>برای آپلود مدارک، عکس یا اسکن واضح،آشکار و خوانا تمامی صفحات مدارک را(حتی صفحات خالی) از طریق سایت ارسال نمایید. </p>
                                <p>دقت: جهت درج صحیح اسامی افراد ذینفع عکس یا اسکن صفحه اول پاسپورت ارسال شود.</p>
                            </div>
                        </Row>
                        <Row>
                            <div
