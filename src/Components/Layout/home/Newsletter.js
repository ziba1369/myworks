    ...
    <Row className="news rtl">
      ...
      <Col xl={12} lg={12} md={12} sm={12} xs={12} className="newsletter">
        ...
        <Row className="allnews ">
          <p className="titlesections "><FontAwesomeIcon icon={faAngleDoubleRight}/><span className="seeall">مشاهده همه اخبار</span><FontAwesomeIcon icon={faAngleDoubleLeft}/></p>
        </Row>
      </Col>
